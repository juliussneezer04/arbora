...
export default function CharacterScript({ children }: Props) {
    ...
    return (
        <group position-y={characterOffsetY}>
            <group ref={(groupRef || undefined) as React.Ref<THREE.Group> | undefined}>
                <group ref={(scaleRef || undefined) as React.Ref<THREE.Group> | undefined} position-y={-offsetY}>
                    <group position-y={offsetY}>
                        <group ref={(childRef || undefined) as React.Ref<THREE.Group> | undefined}>{children}</group>
                    </group>
                </group>
            </group>
        </group>
