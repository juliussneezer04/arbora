...
export default memo(
    ...
    forwardRef<THREE.Object3D, GraphicProps>(function Graphic(
        ...
        return (
            <mesh
                ref={(ref || null) as React.Ref<THREE.Mesh<THREE.BufferGeometry, THREE.Material | THREE.Material[]>> | undefined}
            ...
            >
                {basic ? (
                    <meshBasicMaterial attach="material" {...materialProps}>
                        <texture ref={(textureRef || undefined) as React.Ref<THREE.Texture> | undefined} attach="map" {...textureProps} />
                    </meshBasicMaterial>
                ) : (
